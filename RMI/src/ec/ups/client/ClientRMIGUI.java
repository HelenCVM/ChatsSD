...
public class ClientRMIGUI extends JFrame implements ActionListener{
	...
	public ClientRMIGUI(){
		...
		frame = new JFrame("Clientes Consola");	
		...
		frame.addWindowListener(new java.awt.event.WindowAdapter() {
		    ...
		    public void windowClosing(java.awt.event.WindowEvent windowEvent) {
		    	...
		    	if(chatClient != null){
			    	try {
			        	sendMessage("Chao a todos ya me voy");
	...
	public JPanel getTextPanel(){
		String welcome = "Bienvenido ingrese su nombre y precione Iniciar para comenzar\n";
	...
	public JPanel getUsersPanel(){
		...
		String[] noClientsYet = {"No hay usuarios"};
	...
	public JPanel makeButtonPanel() {		
        ...
        privateMsgButton = new JButton("Enviar Privado");
	...
	public void actionPerformed(ActionEvent e){
		...
		try {
			...
			if(e.getSource() == startButton){
				...
				if(name.length() != 0){
					frame.setTitle(name + "consola");
					textField.setText("");
					textArea.append("Usuario  : " + name + " conectandose al chat...\n");							
					getConnected(name);
					...
					JOptionPane.showMessageDialog(frame, "Ingrese su nombre para iniciar");
				}
			}
